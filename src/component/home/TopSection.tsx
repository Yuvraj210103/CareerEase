const TopSection = () => {
  return (
    <div className="flex items-center justify-center w-full h-full">
      <div className="flex flex-col md:flex-row items-center justify-between md:px-8 px-4 md:pt-8 pt-0 gap-8 md:gap-0 max-w-[1280px] pb-10">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-end">
          <img
            src="assets/home_top_section.svg"
            alt=""
            className="size-[90%]"
          />
        </div>
